...
Задание может выполняться **индивидуально** или **в составе группы до 3 человек**. Для управления версиями будет использоваться Git, для написания документации — Markdown, а для создания статического веб-сайта — языки разметки HTML и CSS (опционально допускается использовать генераторы статических сайтов, такие как Hugo). 
В качестве платформы для размещения репозиториев допустимо использовать как **GitHub**, так и **GitVerse**, что обеспечивает гибкость в выборе инструментов. Также предусмотрено взаимодействие с организациями-партнёрами, включая стажировки, которые будут приниматься к зачёту при оценке.
...
* **Куратора проекта** по «Проектной деятельности» (должно быть согласовано с ответственным за практику на выпускающей кафедре).
...
3. **Создание статического веб-сайта:**
   ...
   - Сайт должен включать:
     ...
     - **Страницу «Ресурсы»** со ссылками на полезные материалы (ссылки на организации-партнёра, сайты и статьи, позволяющие лучше понять суть проекта).
...
5. **Отчёт по практике**
   - Составьте отчёт по проектной (учебной) практике на основании шаблона (структуры), размещённого в папке `reports`. Шаблон (структура) приведён в файле [practice_report_template.docx](ссылка).
...
9. Подготовьте финальный отчёт (в хронологической последовательности опишите этапы работы, отдельно должны быть представлены индивидуальные планы каждого участника).
...
В рамках практики следует придерживаться заданной структуры git-репозитория, приведённой в файле [git_structure.md](ссылка).
...
2. DevTools для «чайников»: [Хабр](https://habr.com/ru/articles/548898/)
3. Элементы HTML: [MDN Web Docs](https://developer.mozilla.org/ru/docs/Web/HTML/Element)
4. Основы HTML: [MDN Web Docs](https://developer.mozilla.org/ru/docs/Learn_web_development/Getting_started/Your_first_website/Creating_the_content)
5. Основы CSS: [MDN Web Docs](https://developer.mozilla.org/ru/docs/Web/CSS)
6. [Doka.guide](https://doka.guide/)
7. Официальная документация Git: [git-scm.com](https://git-scm.com/book/ru/v2)
8. Что такое Git (объясняем на схемах): [Skillbox](https://skillbox.ru/media/code/chto_takoe_git_obyasnyaem_na_skhemakh/)
9. Бесплатный курс на Hexlet по Git: [Hexlet](https://ru.hexlet.io/courses/intro_to_git)
10. Уроки по Markdown: [Hexlet](https://ru.hexlet.io/lesson_filters/markdown)
